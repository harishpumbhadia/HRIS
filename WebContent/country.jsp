	...
	<table width=40%>
		<tr>          
             <div class="form-group">
   			...
   			<td> <input type="text" name="countryName" class="form-control" placeholder="Enter Country Name" id="countryName" pattern="[A-Za-z]+" title="Only Alphabates Allowed " required autofocus>
   			</div>
			</td>
		</tr>
